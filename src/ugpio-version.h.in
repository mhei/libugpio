...
#define LIBUGPIO_VERSION_MAJOR (@LIBUGPIO_VERSION_MAJOR@)

/* The minor version (2, if %LIBUGPIO_VERSION is 1.2.3) */
#define LIBUGPIO_VERSION_MINOR (@LIBUGPIO_VERSION_MINOR@)

/* The micro version (3, if %LIBUGPIO_VERSION is 1.2.3) */
#define LIBUGPIO_VERSION_MICRO (@LIBUGPIO_VERSION_MICRO@)

/* The full version, like 1.2.3 */
#define LIBUGPIO_VERSION        @LIBUGPIO_VERSION@

/* The full version, in string form (suited for string concatenation) */
#define LIBUGPIO_VERSION_STRING "@LIBUGPIO_VERSION@"
